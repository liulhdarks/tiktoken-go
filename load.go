...
type BpeLoader interface {
    ...
    LoadTiktokenBpeFromEmbed(content []byte) (map[string]int, error)
}
...
func loadTiktokenBpe(tiktokenBpeFile string) (map[string]int, error) {
    ...
    return loadTiktokenBpeFromBytes(contents)
}
...
func (l *defaultBpeLoader) LoadTiktokenBpeFromEmbed(content []byte) (map[string]int, error) {
    return loadTiktokenBpeFromBytes(content)
}
